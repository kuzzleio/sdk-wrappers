...
func kuzzle_wrapper_ms_hmset(k *C.kuzzle, key *C.char, entries **C.json_object, elen C.uint, options *C.query_options) *C.void_result {
...
func kuzzle_wrapper_ms_mset(k *C.kuzzle, entries **C.json_object, elen C.uint, options *C.query_options) *C.void_result {
	wrapped := (*[1 << 20]*C.json_object)(unsafe.Pointer(entries))[:elen:elen]
...
func kuzzle_wrapper_ms_msetnx(k *C.kuzzle, entries **C.json_object, elen C.uint, options *C.query_options) *C.bool_result {
	wrapped := (*[1 << 20]*C.json_object)(unsafe.Pointer(entries))[:elen:elen]
	goentries := make([]*types.MSKeyValue, int(elen))
...
func kuzzle_wrapper_ms_pfadd(k *C.kuzzle, key *C.char, elements **C.char, elen C.uint, options *C.query_options) *C.bool_result {
...
func kuzzle_wrapper_ms_pfmerge(k *C.kuzzle, key *C.char, sources **C.char, slen C.uint, options *C.query_options) *C.void_result {
